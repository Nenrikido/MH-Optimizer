...
function Header() {
  ...
  const handleLanguageChange = (e: SelectChangeEvent<'en' | 'fr'>) => {
        ...
        <Select
          ...
          renderValue={(value) => (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <Box component="img" src={value === 'en' ? '/flags/gb.svg' : '/flags/fr.svg'} alt="" sx={{ width: 18, height: 12, borderRadius: '2px' }} />
